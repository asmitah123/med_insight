...
with st.sidebar:
    st.title("MedInsight")
    st.write("Welcome to MedInsight")
    st.write(" Choose an option from the menu below to get started:")

    selected = option_menu('MedInsight',
...
if (selected == 'About Us'):
    ...
    st.write("At MedInsight, our mission is to revolutionize healthcare by offering innovative solutions through predictive analysis. "
    ...
    with col1:
        ...
        st.write("Our Pregnancy Risk Prediction feature uses advanced algorithms to analyze parameters like age, body sugar levels, " 
                "blood pressure, and more. By processing this data, we provide accurate predictions of potential pregnancy risks.")
    ...
    with col2:
        ...
        st.write("Fetal Health Prediction is a key feature of our system, utilizing advanced technology to assess fetal health. "
                 "By analyzing ultrasound data, maternal health, and genetic factors, we provide critical insights into the well-being of the unborn child.")
    ...
    # Closing note
    st.write("Thank you for choosing MedInsight. We are committed to advancing healthcare through technology and predictive analytics. "
